...
int AffineEstimator::runKernel(const cv::Mat* m1, const cv::Mat* m2, cv::Mat* H) {
...
void AffineEstimator::computeReprojError(const cv::Mat* m1, const cv::Mat* m2,
...
bool AffineEstimator::refine(const cv::Mat* m1, const cv::Mat* m2,
...
//bool AffineEstimator::refine(const cv::Mat* m1, const cv::Mat* m2, cv::Mat* model, int maxIters)
//{
